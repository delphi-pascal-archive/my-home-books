...
function  ALFastTagReplace(const SourceString, TagStart, TagEnd: string; ReplaceStrParamName: String;
 AStripParamQuotes: Boolean; const Flags: TReplaceFlags=[rfreplaceall]): string; overload;
